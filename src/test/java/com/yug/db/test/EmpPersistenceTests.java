...
import com.yug.db.repository.EmpJpaRepository;
import com.yug.db.util.MyUtils;
...
public class EmpPersistenceTests {
	...
	public void testFind() throws Exception {
		...
		System.out.println("Emp num:" + emp.getEmpNo() + " Emp name: " + emp.getEname() + " Emp dept : "
				+ emp.getDeptNo() + " hire date : " + MyUtils.formatDate(emp.getHireDate()));
